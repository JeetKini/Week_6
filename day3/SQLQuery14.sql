...
where cast(CreateDate as Date)>='2024-01-01' and cast(CreateDate as Date)<='2024-01-05' and IsActive=1
order by OpportunityStatusId

select * from fn_GetMyTeam

select * from Opportunity
select * from CRMLead where MobileNo='9876567567'

sp_helptext CRM_Usp_GetLeads

select * from [CRMLeadMapping]

  
CREATE PROC [dbo].[CRM_Usp_GetLeads]                 
@UserId INT   
